...
/**
 *  MmitssTrafficControllerInterfaceApp class
 */
class MmitssTrafficControllerInterfaceApp : public ItsFacilityApplicationWaveSae
{
  public:
    MmitssTrafficControllerInterfaceApp();
    virtual ~MmitssTrafficControllerInterfaceApp() = default;
    MmitssTrafficControllerInterfaceApp(const MmitssTrafficControllerInterfaceApp&) = delete;
    MmitssTrafficControllerInterfaceApp& operator=(
        const MmitssTrafficControllerInterfaceApp&) = delete;
  ...
  private:
    ...
    MmitssTrafficControllerInterface m_trafficControl;
};
